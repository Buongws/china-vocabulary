...
export async function GET() {
  const [migration, preferredLanguage, learningExperience, seed, hsk6Chinese, englishWorkLife] = await Promise.all([
    ...
    readFile(join(process.cwd(), 'supabase/migrations/202609150002_learning_experience.sql'), 'utf8'),
