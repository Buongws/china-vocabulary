...
export function Dashboard() {
  ...
  return <>
    ...
    <div className="dashboard-grid"><div className="dashboard-primary">
      ...
      <section className="practice-banner"><span className="icon-tile paper"><PenLine size={24} /></span><div><h3>Để bàn tay giúp bạn ghi nhớ.</h3><p>Luyện nét chữ Hán hoặc thử một bài chính tả tiếng Anh.</p></div><Link href="/practice" className="button outline">Luyện viết <ArrowUpRight size={16} /></Link></section>
