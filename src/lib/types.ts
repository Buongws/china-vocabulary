...
export type SessionItem = { id: string; session_id: string; word_id: string; kind: 'new' | 'review' | 'maintenance'; completed_at: string | null; rating: Rating | null; is_correct: boolean | null; skipped?: boolean };
